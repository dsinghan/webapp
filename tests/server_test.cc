...
class MockSession : public session {
    public:
    MockSession(boost::asio::io_service& io_service, http::server::echo_request_handler& echo_handler, http::server::static_request_handler& static_handler, std::map<std::string, std::string> locations) : session(io_service, echo_handler, static_handler, locations) {}
